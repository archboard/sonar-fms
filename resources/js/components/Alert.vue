...
export default defineComponent({
  ...
  setup ({ level }) {
    ...
    const iconColors = {
      ...
      neutral: 'text-gray-400 dark:text-gray-200',
    }
    const textColors = {
    ...
    const closeColors = {
      ...
      error: 'bg-red-100 text-red-500 hover:bg-red-100 focus:ring-offset-red-50 focus:ring-red-600 dark:bg-red-800 dark:text-red-400',

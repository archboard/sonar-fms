  ...
  <Layout>
    <div>
      <span class="rounded-md shadow-sm self-start flex w-full">
        <a :href="$route('oidc.login')" class="px-4 py-3 text-base leading-6 flex w-full border border-transparent font-medium rounded-md text-white focus:outline-none transition ease-in-out duration-150 items-center justify-center text-white bg-[#00427c] hover:bg-[#003463] focus:ring focus:ring-[#006bc9] focus:ring-offset-2 transition">
